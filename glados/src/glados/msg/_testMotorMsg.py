"""autogenerated by genmsg_py from testMotorMsg.msg. Do not edit."""
import roslib.message
import struct


class testMotorMsg(roslib.message.Message):
  _md5sum = "9d5c2dcd348ac8f76ce2a4307bd63a13"
  _type = "glados/testMotorMsg"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(testMotorMsg, self).__init__(*args, **kwds)
