"""autogenerated by genmsg_py from stateEstimation.msg. Do not edit."""
import roslib.message
import struct


class stateEstimation(roslib.message.Message):
  _md5sum = "9d5c2dcd348ac8f76ce2a4307bd63a13"
  _type = "glados/stateEstimation"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(stateEstimation, self).__init__(*args, **kwds)
